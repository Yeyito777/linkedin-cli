...
linkedin experience update ID_OR_EXACT_COMPANY --organization-id COMPANY_ID [--yes]
linkedin verification workplace start --email-stdin [--company-id ID] [--yes]
linkedin verification workplace complete CODE [--yes]
linkedin organization create NAME --public-name SLUG --industry NAME --industry-id ID [--logo IMAGE] [--yes]
